          ...
          <section class="section no-pdy overflow-hidden section-contact bg-transparent" id="contact">
            <div class="container">
              ...
              <div class="nk-block block-contact">
						...
						setup_postdata( $post );
						?>
                                        <h2 class="title animated fadeInUp" data-animate="fadeInUp" data-delay=".1" style="visibility: visible; animation-delay: 0.1s;"><?php the_title(); ?></h2>
						...
						setup_postdata( $post );
						?>
										<a class="btn btn-lg btn-theme-dark" href="#" data-bs-toggle="modal" data-bs-target="#modal-form"><span class="btn-text"><?php the_content(); ?></span></a>
						<?php } } wp_reset_postdata(); ?>
                                    </div>
                                </div>
                            </div><!-- .col -->
